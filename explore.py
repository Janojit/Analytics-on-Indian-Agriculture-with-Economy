...
def rice():
    ...
    st.write(('Line Plot Between Year and Rice Production').center(115,'-'))
    ...
    st.write(('Bar Plot Between States and Rice Production').center(115,'-'))
    sns.barplot(temp["State Name"],temp["RICE PRODUCTION (1000 tons)"])
    plt.xticks(rotation=90)
    st.pyplot(fig)
    fig1 = plt.figure(figsize=(10,15))
    st.write(('Pie Plot Between States and Rice Production').center(115,'-'))
...
def wheat():
    ...
    st.write(('Line Plot Between Year and Wheat Production').center(115,'-'))
    ...
    fig = plt.figure(figsize=(15,15))
    st.write(('Bar Plot Between States and Wheat Production').center(115,'-'))
    sns.barplot(temp["State Name"],temp["WHEAT PRODUCTION (1000 tons)"])
    plt.xticks(rotation=90)
    st.pyplot(fig)
    fig1 = plt.figure(figsize=(10,15))
    st.write(('Pie Plot Between States and Wheat Production').center(115,'-'))
...
def kharif():
    ...
    st.write(('Line Plot Between Year and Kharif Production').center(115,'-'))
    ...
    fig = plt.figure(figsize=(15,15))
    st.write(('Bar Plot Between States and Kharif Production').center(115,'-'))
    sns.barplot(temp["State Name"],temp["KHARIF SORGHUM PRODUCTION (1000 tons)"])
    plt.xticks(rotation=90)
    st.pyplot(fig)
    fig1 = plt.figure(figsize=(10,15))
    st.write(('Pie Plot Between States and Kharif Production').center(115,'-'))
...
def rabi():
    ...
    st.write(('Line Plot Between Year and Rabi Production').center(115,'-'))
    ...
    fig = plt.figure(figsize=(15,15))
    st.write(('Bar Plot Between States and Rabi Production').center(115,'-'))
    sns.barplot(temp["State Name"],temp["RABI SORGHUM PRODUCTION (1000 tons)"])
    plt.xticks(rotation=90)
    st.pyplot(fig)
    fig1 = plt.figure(figsize=(10,15))
    st.write(('Pie Plot Between States and Rabi Production').center(115,'-'))
...
def q1():
    ...
    st.write(('Bar Plot Between States and Total Crop Production').center(115,'-'))
    st.pyplot(fig)
    st.write(('Pie Plot Between States and Total Crop Production').center(115,'-'))
    st.pyplot(fig1)
...
def q3():
    ...
    plt.show()
    st.write(('Bar Plot Between States and Total Agriculture Land Area').center(115,'-'))
    st.pyplot(fig)
    st.write(('Pie Plot Between States and Total Agriculture Land Area').center(115,'-'))
    st.pyplot(fig1)
...
def q5():
    st.write(('Join Plot Between Total Agriculture Land Area and Total Crop Production').center(115,'-'))
    fig = sns.jointplot("Total Area (1000 ha)","Total Production (1000 tons)",data=df,kind="reg")
    st.pyplot(fig)
    fig1 = plt.figure(figsize=(10,6))
    st.write(('Correlation Heatmap Between Total Agriculture Land Area and Total Crop Production').center(115,'-'))
...
def q6():
    ...
    st.write(('Line Plot Between Year and Total Crop Production').center(115,'-'))
    fig = px.line(temp, 'Year', 'Total Production (1000 tons)')
    st.plotly_chart(fig)

def q7():
    temp = df1.sort_values(by='Total Yield (Kg per ha)')
    st.write(('Bar Plot Between States and Total Yield').center(115,'-'))
...
def q9():
    st.write(('Join Plot Between Rainfall and Total Crop Production').center(115,'-'))
    fig = sns.jointplot("Rainfall(mm)","Total Production (1000 tons)",data=df,kind="reg")
    st.pyplot(fig)
    fig1 = plt.figure(figsize=(10,6))
    st.write(('Correlation Between Rainfall and Total Crop Production').center(115,'-'))
...
def q10():
    ...
    st.write(('Line Plot To Analyse Economy').center(115,'-'))
    ...
    st.write(('Correlation Heatmap to Analyse Economy').center(115,'-'))
